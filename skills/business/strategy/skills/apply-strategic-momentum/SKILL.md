...
related: [apply-graceful-withdrawal, apply-commit-with-no-retreat, apply-crisis-opportunism, apply-protracted-resistance]
verified: true
---

# Apply Strategic Momentum
...
### Step 1: Accumulate 势 before committing
...
- **Relationship势:** Do you have the customer trust, partner relationships, or distribution that will carry the campaign?
- **Product势:** Is the product differentiated enough to create pull, or will the campaign reveal weakness?
- **Operational势:** Can you sustain the campaign — fulfil orders, support customers, iterate quickly — once it launches?
- **Financial势:** Do you have the reserves to sustain the campaign through the inevitable slow period before momentum builds?
- **Market势:** Is the market ready — is the need acute enough, is the technology mature enough, is the timing right?

Do not launch until势 is sufficient in at least 3 of these 5 dimensions.

### Step 2: Identify the orthodox (正) force
正 is your primary, expected form of engagement — the direct competitive move the opponent can see and must respond to.

Examples:
- The core product competing on features and price
- The direct sales team calling on the target accounts
- The main marketing campaign on the primary channel
- The direct negotiation proposal
...
### Step 3: Identify the unorthodox (奇) force
...
Examples:
- A new distribution channel the opponent has no presence in
- A strategic partnership that changes the product's reach
- A new segment adjacent to the primary market
- A pricing model change (subscription vs. perpetual, usage vs. seat)
- A technology integration that changes the switching cost equation
- A regulatory or certification that blocks competitor entry
...
### Step 4: Find the moment of maximum advantage
...
- Your product/capability has a clear differentiation the opponent cannot rapidly copy
- The opponent is distracted — launching in a different market, managing an internal transition, responding to a regulatory issue
- The market is at the right inflection point — early adopters are ready, but fast followers have not yet committed
- Your operational capability can sustain the demand the campaign will generate
...
### Step 5: Strike fast and decisively
...
- Shorten decision cycles — eliminate approvals and committees that slow execution
- Pre-position resources so the campaign does not stall at the launch moment
- Maintain tempo — the advantage of striking first is lost if you pause and allow the opponent to recover and reorganise
...
### Step 6: Sustain from what you win
...
- New customers generate revenue that funds the next customer acquisition cycle
- Won market position provides the platform for expanding the attack
- Partner relationships secured in the campaign open the next distribution channel
- Technology capabilities built during the campaign reduce the cost of the next iteration
...
- Build 势 before striking. Launching before potential has accumulated produces a campaign that exhausts resources without building momentum.
- Never rely on 正 alone. Direct force against a prepared opponent produces direct counter-force. 奇 is what creates undefended openings.
- Speed after commitment. Before commitment, be patient and accumulate. After commitment, be fast. Prolonged campaigns in either phase are costly.
- Sustain from territory won. Plan the self-sustaining mechanism from the start — what does winning produce that funds the next move?
- Do not fight prolonged campaigns without resource superiority. If resources are limited, design for a fast, decisive strike that captures a sustainable position, not a war of attrition.

## Examples

**Amazon Prime (势 accumulation then flywheel release):**
Amazon built distribution infrastructure (势) for years before launching Prime. Prime's "free shipping" 正 (direct attack on friction cost) combined with 奇 (binding customers to the Amazon ecosystem with sunk cost and exclusive benefits) created self-sustaining momentum: Prime members spend 4.5× more than non-Prime members, generating resources to fund the next round of accumulation.

**Apple iPod → iTunes → iPhone (sequential 势 building):**
Apple built势 in each stage: iPod established the hardware and user experience capability; iTunes established the ecosystem relationship with music labels and 400M+ accounts; iPhone combined both into a platform. Each campaign was not just a product launch but a势 accumulation for the next campaign. The 正 at each stage (great hardware) was reinforced by 奇 (the ecosystem lock-in competitors couldn't replicate).

**Startup product launch (accumulate, combine, strike):**
- 势 accumulation phase (6 months): build with 20 design partners, get 3 reference case studies, establish integration partnerships with 2 adjacent platforms
- 正: direct sales outreach to 500 target accounts with differentiated product and case studies
- 奇: announce partnership with the dominant ecosystem platform simultaneously — competitors learn their customers are evaluating you through a channel they have no access to
- Result: 势 of the partner announcement amplifies the 正 campaign; total reach is 5× what direct sales alone would have achieved
