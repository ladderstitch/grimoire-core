...
related: [apply-gilded-retirement]
verified: true
---
...
### Step 1: Before enforcement is needed — establish rules with explicit rationale
...
- **Write the rule in terms of what it protects, not just what it prohibits.** "No deploying to production without a code review" is a prohibition; "no deploying to production without a code review, because undiscovered bugs in production cost 10× more to fix than bugs found in review" is a protection. The rationale makes the rule portable to edge cases.
- **Publish the enforcement consequence.** Rules with undefined enforcement consequences allow violators to negotiate the penalty post-hoc. Rules with defined consequences remove the negotiation: the question is whether a violation occurred, not what the penalty should be.
- **Apply the rule to yourself visibly.** Before a high-stakes enforcement moment, the enforcer should be seen following the same rules as everyone else. This establishes that the rule is not an instrument of power but a constraint that applies equally.

### Step 2: When a visible violation occurs — determine whether the exception impulse is legitimate
...
### Step 3: Communicate enforcement as institutional principle, not personal judgment

The framing of enforcement determines whether it strengthens or complicates the institution:

- **Institutional framing:** "The rule requires X. Ma Su disobeyed orders at Jieting. The rule is enforced."
- **Personal framing:** "I am disappointed in Ma Su and am imposing this consequence for his poor judgment."
...
### Step 4: Acknowledge the cost genuinely — Zhuge Liang's tears

The tears are not theatrical. They communicate three things simultaneously:

1. **The enforcer understands the human cost.** This distinguishes principled enforcement from indifferent bureaucracy. The officer who enforces a rule without any acknowledgment of its cost signals that they are not a full moral agent making a difficult decision — they are a mechanism. Mechanisms are not respected; they are gamed.

2. **The relationship is real.** Acknowledging genuine regard for the person being enforced against demonstrates that the enforcement is not motivated by dislike, personal rivalry, or indifference. The enforcement is costing the enforcer something. That cost is visible. This makes the institutional principle legible: the rule applies even when enforcement is personally costly to the enforcer.

3. **The enforcement is deliberate.** Tears alongside a signature communicate that the decision was made fully consciously, with complete awareness of what it required. This is the opposite of enforcement-by-policy ("the system requires this"). The deliberate enforcement of a costly rule creates a different institutional precedent than the mechanical application of a procedure.
...
### Step 5: Use the enforcement event to clarify what the rule means going forward

Every high-visibility enforcement event defines the rule's scope for all subsequent cases. After the enforcement:

- **State specifically what rule was violated and how.** "Ma Su was ordered to fortify the road junction. He positioned on the mountain instead. The violation was the disobedience of a direct written order, not the tactical choice itself." This prevents the precedent from being broader than intended.
- **Confirm that the relationship did not alter the enforcement.** Explicitly acknowledging the relationship and confirming the enforcement is what establishes the relationship-independence of the rule. Omitting this leaves ambiguity about whether the enforcement was despite the relationship or because of some change in the relationship.
- **Clarify any edge cases the event raised.** If the violation created ambiguity about what the rule requires in similar situations, resolve the ambiguity explicitly rather than leaving it for the next event.

### Step 6: Preserve what can be preserved — enforcement is about the principle, not comprehensive punishment
...
- The rule's required consequence: enforced fully
- Collateral consequences beyond the rule's scope: minimised where possible
...
- Enforce the rule even when enforcement is personally costly. The entire value of the enforcement-integrity principle is that rules apply regardless of relationship or status. An enforcement that occurs only when it is costless to the enforcer does not establish institutional credibility — it establishes that the enforcer enforces when comfortable.
- Frame enforcement institutionally, not personally. "The rule requires X" is not a deflection from responsibility — it is an accurate description of what is happening. Rules exist precisely so that enforcement does not depend on the enforcer's personal assessment of each case.
- Never reduce the rule's consequences informally while formally applying them. A formal enforcement combined with informal mitigation (the person keeps their title, the consequence is reduced in practice) is the worst outcome: the institution records the enforcement but the actual consequence signals that the formal rule does not reflect the real expectation. This produces maximum ambiguity at minimum institutional benefit.
- Change rules through formal process, not through enforcement exceptions. If the enforcement event reveals that the rule is wrong, enforce the current rule and then change the rule formally. Retroactively adjusting a rule to accommodate a specific case — "we'll treat this as a special situation" — is an exception wearing the clothes of rule revision.
- Apply the standard to yourself first. Institutional credibility on enforcement requires that the enforcer be visibly subject to the same rules. An enforcer who applies rules to others but exempts themselves loses the authority that makes enforcement meaningful. The enforcement of Zhuge Liang's own penalty for the failed expedition (he demoted himself three ranks before Zhuge Liang executed Ma Su) established that the standards were universal.
- Acknowledge the relationship explicitly, then enforce. Silence about the relationship during enforcement creates ambiguity: is the enforcement despite the relationship or because the relationship has changed? Name the relationship and confirm the enforcement is despite it.

## Examples

**Netflix performance standards applied to senior tenured employees:**
Netflix's culture document states that adequate performance gets a generous severance. The credibility of this standard was established by applying it to senior, tenured employees — not only to new hires or underperformers who were already marginal. The visible departures of high-status employees under the performance standard created the institutional reality that the standard was genuinely universal. If departures had occurred only among employees with no status, the standard would have been perceived as applicable only to the powerless. The Ma Su enforcement pattern: the highest-cost visible enforcement cases establish the rule's universality.

**Ray Dalio submitting to Bridgewater's performance review process:**
Bridgewater's culture of radical transparency and algorithmic performance tracking was built on Dalio submitting to the same evaluation processes as every other employee — including public performance feedback that was at times unflattering. The institutional credibility of the system depended on Dalio's visible subjection to it. If Dalio had exempted himself, the system would have become an instrument for evaluating employees by the founder's standards without reciprocal accountability. The principle: the enforcer's self-application is the foundation of the institution's authority to apply the rule to others.

**Enforcing a security review gate for a critical deadline:**
