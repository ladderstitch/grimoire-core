---
name: apply-strategic-endurance
...
### Step 1: Accept survival terms — choose what keeps you alive
...
### Step 2: Create the deliberate reminder — the gall equivalent
...
- A one-page document: what happened, who caused it, what it cost, what the reversal objective is — reviewed weekly or monthly
- A number that represents the defeat (the share price at the lowest, the revenue lost, the position surrendered) displayed where you see it daily
- A physical object or environment that represents the rebuild rather than the comfort of the current position (Goujian's brushwood was literal; the modern equivalent is whatever removes the comfort that produces complacency)
...
### Step 3: Rebuild systematically — under the opponent's radar
...
### Step 4: Maintain patience through the long timeline
...
- Set phase milestones with specific conditions: "we move to Phase 3 when we have X customers / Y capital / Z technical capability"
- Reject short-term opportunities that compromise the long-term objective — Goujian declined early opportunities for retaliation that would have been crushed
- Manage the team through the patience period: the gall-tasting ritual was also a leadership tool, aligning Goujian's court behind the long-term goal rather than letting them pursue short-term accommodation with Wu
- Review and recommit at each milestone; patience without active recommitment drifts into passive resignation — the defeat becomes permanent by inertia

### Step 5: Strike when the opponent is overextended — not when you are merely ready
